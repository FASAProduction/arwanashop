...
<script src="<?php echo base_url(); ?>komponen/assets/js/jquery-3.4.1.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/bootstrap.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/jquery.countdown.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/jquery.nice-select.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/jquery.nicescroll.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/slick.min.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/biolife.framework.js"></script>
<script src="<?php echo base_url(); ?>komponen/assets/js/functions.js"></script>
</body>
